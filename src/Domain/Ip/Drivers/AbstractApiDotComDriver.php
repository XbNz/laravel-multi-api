...
class AbstractApiDotComDriver implements Driver
{
    public const API_URL = 'https://ipgeolocation.abstractapi.com/v1/';
    ...
    public function getRequests(array $dataObjects): Collection
    {
        ...
        $generator = static function (array $ipDataObjects) {
            foreach ($ipDataObjects as $ipData) {
                $uri = Uri::withQueryValue(new Uri(self::API_URL), 'ip_address', $ipData->ip);
