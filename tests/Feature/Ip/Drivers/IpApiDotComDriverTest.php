...
class IpApiDotComDriverTest extends \XbNz\Resolver\Tests\TestCase
{
    ...
    public function provided_an_incorrect_api_key_it_throws_the_expected_exception(): void
    {
        ...
        //TODO: Implement this type of fail-safe test for all other API drivers.
        // Then move on to the 1.1 branch and try out the importers
        // Maybe use the new lazy collection package to speed things up?!?
